...
def next_1():
    ...
    button_1 = Button(secondmenu, text="Hawiian", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_1.place(x=23, y=60, width=125, height=37)
    button_2 = Button(secondmenu, text="Pepperoni", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_2.place(x=203, y=60, width=125, height=37)
    button_3 = Button(secondmenu, text="Cheese", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_3.place(x=383, y=60, width=125, height=37)
    button_4 = Button(secondmenu, text="Ham & Cheese", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_4.place(x=23, y=105, width=125, height=37)
    button_5 = Button(secondmenu, text="Beef & Onion", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_5.place(x=203, y=105, width=125, height=37)
    button_6 = Button(secondmenu, text="Vegetarian", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_6.place(x=383, y=105, width=125, height=37)
    button_7 = Button(secondmenu, text="Cheesy Garlic", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_7.place(x=23, y=150, width=125, height=37)
    button_8 = Button(secondmenu, text="""Chicken, Bacon & 
    Aioli""", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_8.place(x=203, y=150, width=125, height=37)
    button_9 = Button(secondmenu, text="""Chicken & 
    Camembert""", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_9.place(x=383, y=150, width=125, height=37)
    button_10 = Button(secondmenu, text="Buffalo Chicken", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_10.place(x=23, y=195, width=125, height=37)
    button_11 = Button(secondmenu, text="Italian Parmesan", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
    button_11.place(x=203, y=195, width=125, height=37)
    button_12 = Button(secondmenu, text="""Double Bacon 
    Cheeseburger""", bg = "#cc4125", command=lambda: calc(button_1,pizza_num,calc))
...
def calc(button_1,pizza_num,calc):
    global pizza_p
    pizza_p = pizza_p + 1
    if pizza_p == pizza_num:
