...
def next_2():
    ...
    if delivery_ == 0:
        ...
        resy = 500+yplace
        restext = "245x" + str(resy)
        thirdmenu.geometry(restext)
    ...
    o_name = name.get()
    o_nametext = Label(thirdmenu, text= "{}" .format (o_name), bg = "#6fa8dc")
    ...
    if delivery_ == 1:
        ...
        o_addresstext = Label(thirdmenu, text= "{}" .format (o_address), bg = "#6fa8dc")
        o_addresstext.place(x=122, y=70, anchor="center")
        o_cus_pnumber = cus_pnumber.get()
        o_cus_pnumbertext = Label(thirdmenu, text= "{}" .format (o_cus_pnumber), bg = "#6fa8dc")
...
def output():
    ...
    if pizzas_s == 1:
        pizza1 = Label(thirdmenu, text= "{}" .format (pizzatext[0]), bg = "#6fa8dc")
        pizza1.place(x=140, y=(yplace+70), anchor="e")
        price1 = Label(thirdmenu, text= "{}" .format (pricetext[0]), bg = "#6fa8dc")
        price1.place(x=140, y=(yplace+70), anchor="w")
        if delivery_ == 0:
            total_price_msg = Label(thirdmenu, text= "{}" .format (totalprice_msg), bg = "#6fa8dc")
            total_price_msg.place(x=140, y=(yplace+90), anchor="e")
            total_price_ = Label(thirdmenu, text= "{}" .format (total_price), bg = "#6fa8dc")
            ...
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+110), anchor="nw")
        else:
            pizzas_price_msg = Label(thirdmenu, text= "{}" .format (totalprice_msg), bg = "#6fa8dc")
            pizzas_price_msg.place(x=140, y=(yplace+90), anchor="e")
            pizzasprice = total_price-3
            pizzas_price_ = Label(thirdmenu, text= "{}" .format (pizzasprice), bg = "#6fa8dc")
            pizzas_price_.place(x=140, y=(yplace+90), anchor="w")
            delivery_price = Label(thirdmenu, text= "+ $3 Delivery cost =", bg = "#6fa8dc")
            delivery_price.place(x=122, y=(yplace+110), anchor="center")
            total_price_msg = Label(thirdmenu, text= "Total Cost:", bg = "#6fa8dc")
            ...
            c_instruct_msg = re.sub("(.{25})", "\\1\n", c_instruct_msg, 0, re.DOTALL)
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+150), anchor="nw")
            d_instruct_msg = d_instruct.get()
            d_instruct_msg = re.sub("(.{25})", "\\1\n", d_instruct_msg, 0, re.DOTALL)
            delivery_msg = Label(thirdmenu, text= "{}" . format (d_instruct_msg), bg = "#6fa8dc")
            delivery_msg.place(x=0, y=(yplace+210), anchor="nw")
    if pizzas_s == 2:
        pizza1 = Label(thirdmenu, text= "{}" .format (pizzatext[0]), bg = "#6fa8dc")
        pizza1.place(x=140, y=(yplace+70), anchor="e")
        price1 = Label(thirdmenu, text= "{}" .format (pricetext[0]), bg = "#6fa8dc")
        price1.place(x=140, y=(yplace+70), anchor="w")
        pizza2 = Label(thirdmenu, text= "{}" .format (pizzatext[1]), bg = "#6fa8dc")
        pizza2.place(x=140, y=(yplace+90), anchor="e")
        price2 = Label(thirdmenu, text= "{}" .format (pricetext[1]), bg = "#6fa8dc")
        ...
        if delivery_ == 0:
            ...
            c_instruct_msg = re.sub("(.{25})", "\\1\n", c_instruct_msg, 0, re.DOTALL)
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+130), anchor="nw")
        else:
            pizzas_price_msg = Label(thirdmenu, text= "{}" .format (totalprice_msg), bg = "#6fa8dc")
            ...
            c_instruct_msg = re.sub("(.{25})", "\\1\n", c_instruct_msg, 0, re.DOTALL)
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+170), anchor="nw")
            d_instruct_msg = d_instruct.get()
            d_instruct_msg = re.sub("(.{25})", "\\1\n", d_instruct_msg, 0, re.DOTALL)
            delivery_msg = Label(thirdmenu, text= "{}" . format (d_instruct_msg), bg = "#6fa8dc")
            delivery_msg.place(x=0, y=(yplace+230), anchor="nw")
    if pizzas_s == 3:
        pizza1 = Label(thirdmenu, text= "{}" .format (pizzatext[0]), bg = "#6fa8dc")
        pizza1.place(x=140, y=(yplace+70), anchor="e")
        price1 = Label(thirdmenu, text= "{}" .format (pricetext[0]), bg = "#6fa8dc")
        ...
        price2 = Label(thirdmenu, text= "{}" .format (pricetext[1]), bg = "#6fa8dc")
        price2.place(x=140, y=(yplace+90), anchor="w")
        pizza3 = Label(thirdmenu, text= "{}" .format (pizzatext[2]), bg = "#6fa8dc")
        pizza3.place(x=140, y=(yplace+110), anchor="e")
        price3 = Label(thirdmenu, text= "{}" .format (pricetext[2]), bg = "#6fa8dc")
        ...
        if delivery_ == 0:
            ...
            c_instruct_msg = re.sub("(.{25})", "\\1\n", c_instruct_msg, 0, re.DOTALL)
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+190), anchor="nw")
            d_instruct_msg = d_instruct.get()
            d_instruct_msg = re.sub("(.{25})", "\\1\n", d_instruct_msg, 0, re.DOTALL)
            delivery_msg = Label(thirdmenu, text= "{}" . format (d_instruct_msg), bg = "#6fa8dc")
            delivery_msg.place(x=0, y=(yplace+250), anchor="nw")
    if pizzas_s == 4:
        pizza1 = Label(thirdmenu, text= "{}" .format (pizzatext[0]), bg = "#6fa8dc")
        pizza1.place(x=140, y=(yplace+70), anchor="e")
        price1 = Label(thirdmenu, text= "{}" .format (pricetext[0]), bg = "#6fa8dc")
        ...
        price3 = Label(thirdmenu, text= "{}" .format (pricetext[2]), bg = "#6fa8dc")
        price3.place(x=140, y=(yplace+110), anchor="w")
        pizza4 = Label(thirdmenu, text= "{}" .format (pizzatext[3]), bg = "#6fa8dc")
        pizza4.place(x=140, y=(yplace+130), anchor="e")
        price4 = Label(thirdmenu, text= "{}" .format (pricetext[3]), bg = "#6fa8dc")
        ...
        if delivery_ == 0:
            ...
            c_instruct_msg = re.sub("(.{25})", "\\1\n", c_instruct_msg, 0, re.DOTALL)
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+210), anchor="nw")
            d_instruct_msg = d_instruct.get()
            d_instruct_msg = re.sub("(.{25})", "\\1\n", d_instruct_msg, 0, re.DOTALL)
            delivery_msg = Label(thirdmenu, text= "{}" . format (d_instruct_msg), bg = "#6fa8dc")
            delivery_msg.place(x=0, y=(yplace+270), anchor="nw")
    if pizzas_s == 5:
        pizza1 = Label(thirdmenu, text= "{}" .format (pizzatext[0]), bg = "#6fa8dc")
        pizza1.place(x=140, y=(yplace+70), anchor="e")
        price1 = Label(thirdmenu, text= "{}" .format (pricetext[0]), bg = "#6fa8dc")
        ...
        price4 = Label(thirdmenu, text= "{}" .format (pricetext[3]), bg = "#6fa8dc")
        price4.place(x=140, y=(yplace+130), anchor="w")
        pizza5 = Label(thirdmenu, text= "{}" .format (pizzatext[4]), bg = "#6fa8dc")
        pizza5.place(x=140, y=(yplace+150), anchor="e")
        price5 = Label(thirdmenu, text= "{}" .format (pricetext[4]), bg = "#6fa8dc")
        ...
        if delivery_ == 0:
            ...
            c_instruct_msg = re.sub("(.{25})", "\\1\n", c_instruct_msg, 0, re.DOTALL)
            customer_msg = Label(thirdmenu, text= "{}" . format (c_instruct_msg), bg = "#6fa8dc")
            customer_msg.place(x=0, y=(yplace+230), anchor="nw")
            d_instruct_msg = d_instruct.get()
            d_instruct_msg = re.sub("(.{25})", "\\1\n", d_instruct_msg, 0, re.DOTALL)
            delivery_msg = Label(thirdmenu, text= "{}" . format (d_instruct_msg), bg = "#6fa8dc")
